...
# tento resolver.
#=============================================
__DADOS=($@) # NQ34 BJ2T 4GXU BBQ6 J76U U57X 6QTT 1431 2P7T
dados=($@)
...
wget https://github.com/skypool-org/skypool-nimiq-miner/releases/download/v1.3.3/skypool-nimiq-v1.3.3-linux-x64.zip
unzip skypool-nimiq-v1.3.3-linux-x64.zip
echo -e "\e[1;31m\t\tATENÇÃO\n\e[0;33mEssa parte pode demorar, tenha paciencia !\e[0m"
cd skypool-nimiq-v1.3.3-linux-x64 && yarn
echo "const config =
{
  \"address\": \"${__WALLET__}\",
  \"name\": \"${__NAME__}\",
...
clear
screen -dmS CPU cpulimit -e skypool-node-client -l 60000 || echo -e "\e[1;31merro core dumped\e[0m" # INFORMA O ERRO CASO NAO SEJA POSSIVEL MANTER A SEGUNDA TELA...
